...
public class StructTests
{
  ...
  {
    var parser = from a in Parse.AnyByte from b in Parse.AnyByte select new { A = a, B = b };
  ...
  {
    var parser = from a in Parse.Int16 from b in Parse.Int16 select new { A = a, B = b };
  ...
  {
    var parser = from a in Parse.UInt16 from b in Parse.UInt16 select new { A = a, B = b };
  ...
  {
    var parser = from a in Parse.Int32 from b in Parse.Int32 select new { A = a, B = b };
  ...
  {
    var parser = from a in Parse.UInt32 from b in Parse.UInt32 select new { A = a, B = b };
  ...
  {
    var parser = from a in Parse.Int64 from b in Parse.Int64 select new { A = a, B = b };
  ...
  {
    var parser = from a in Parse.UInt64 from b in Parse.UInt64 select new { A = a, B = b };
  ...
  {
    var parser = from a in Parse.Single from b in Parse.Single select new { A = a, B = b };
  ...
  {
    var parser = from a in Parse.Double from b in Parse.Double select new { A = a, B = b };
  ...
  {
    var parser = from value in Parse.String select value;
