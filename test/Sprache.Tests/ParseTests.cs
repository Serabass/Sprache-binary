...
namespace Sprache.Binary.Tests
{
  public class ParseTests
  {
    ...
    {
      var p = Parse.Byte(0).Once().Then(a => Parse.Byte(1).Once().Select(b => a.Concat(b)));
    ...
    {
      var ab = from a in Parse.Byte(0) from b in Parse.Byte(1) select new byte[] { 0, 1 };
